...
export class UserRepository {
  ...
  async updateUser(id: string, updates: Partial<{ username: string; role: UserRole; passwordHash: string; tenantId: string; deletedAt: Date | null }>) {
  ...
  async update(id: string, updates: Partial<{ username: string; role: UserRole; passwordHash: string; tenantId: string; deletedAt: Date | null }>) {
